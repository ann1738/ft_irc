...
CMD_SRCS = NICK.cpp TOPIC.cpp JOIN.cpp PART.cpp PRIVMSG.cpp NOTICE.cpp MODE.cpp PING.cpp LIST.cpp INVITE.cpp KICK.cpp QUIT.cpp
SRCS =  main.cpp initialParse.cpp server.cpp user.cpp channel.cpp commandParse.cpp command.cpp redirectCommand.cpp reply.cpp authenticate.cpp messageUtils.cpp ${CMD_SRCS}
